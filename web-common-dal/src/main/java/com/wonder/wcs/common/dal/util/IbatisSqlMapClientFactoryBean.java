...
/**
 *该类实现了ibatis2.3.2以后版本功能.新功能主要有于可以配置多个sql-map.xml文件.注不兼容2.3.2以前版本
 *
 * @since 24.02.2004
 ...
 * 
 * @author xuhua.liu
 * @version $Id: TunionSqlMapClientFactoryBean.java, v 0.1 2011-9-25 下午09:54:57 bo.yu Exp $
 */
public class IbatisSqlMapClientFactoryBean implements FactoryBean, InitializingBean,
        ISqlMapClientFactoryBean {
    ...
    public IbatisSqlMapClientFactoryBean() {
